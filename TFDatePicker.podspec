...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://www.wannabegeek.com/?p=444"
  s.screenshots  = "http://www.wannabegeek.com/wp-content/uploads/2012/09/datepicker.jpg"
  ...
  s.source       = { :git => "http://EXAMPLE/TFDatePicker.git", :tag => "0.0.1" }
